<%@ Page Language="C#" AutoEventWireup="true" CodeFile="artists-details.aspx.cs" Inherits="Default" %>
...
<head>
	...
	<body class="premium standard">
		<form runat="server">
			<header class="header remodal-bg">
            <asp:Panel runat="server">
				<label>Select Artist</label>
				<asp:DropDownList ID="artistList" runat="server"></asp:DropDownList>
				<asp:Button runat="server" ID="searchButton" Text="Search" OnClick="SearchButton_OnClick"></asp:Button>
			</asp:Panel>
         </header>
		<noscript>
		...
		<asp:Panel runat="server" ID="artistPanel" Visible="false">
			<div class="wrapper mod-standard mod-gray">
			<!-- Show artist details -->
			<asp:Repeater runat="server" ID="details">
				<ItemTemplate>
					<div class="details-banner">
						...
						<div class="details-banner--hero">
							<img 
								...
								src="<%#Eval("heroURL")%>" 
								srcset="<%#Eval("heroURL")%>, <%#Eval("heroURL")%> 2x" 
								alt="<%#Eval("artistName")%>"
							>
						</div>
						<div class="details-banner--info">
							<a href="#" class="details-banner--info--box">
								<img class="details-banner--info--box--img"
									src="<%#Eval("artistImageURL")%>"
									srcset="<%#Eval("artistImageURL")%>, <%#Eval("artistImageURL")%> 2x" 
									alt="alt">
							</a>
							<h1 class="details-banner--info--name">
								<a class="details-banner--info--name--link" href="#"><%#Eval("artistName") %></a>
							</h1>
						</div>
					</div>
				</ItemTemplate>
